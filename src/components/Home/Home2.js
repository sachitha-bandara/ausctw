        ...
        <Row>
          <Col md={12} className="home-about-body">
            ...
            <p style={{paddingLeft:"20px", fontSize:"1.2em !important"}}>
              ...
              <br />
              <br />
              <strong>To facilitate maximum participation, all attendees are invited to present a poster at the workshop. More information about the poster abstract submissions is available in "Submissions" page.</strong>
              <br/>
